    ...
    capabilities: [
      {
        ...
        description:
          "Helps teams review denials, build appeal outlines, and improve documentation for faster collections.",
      },
      {
        name: "PPO Strategy Advisor",
        description:
          "Supports fee review, payer analysis, and participation decisions that protect profitability.",
      },
    ],
  },
  {
    ...
    capabilities: [
      {
        ...
        description:
          "Helps teams explain clinical findings, next steps, and patient choices in clearer language.",
      },
      {
        name: "Case Acceptance Coach",
        description:
          "Builds presentation talking points, follow-up plans, and financing language that make yes easier.",
      },
      {
        name: "AI Smile Studio",
        description:
          "Creates personalized case visuals that help patients picture outcomes before they commit.",
      },
    ],
  },
  {
    ...
    capabilities: [
      {
        name: "Practice Growth Coach",
        description:
          "Helps identify growth opportunities, improve campaign follow-up, and strengthen production plans.",
      },
      {
        name: "Practice Design & Expansion Advisor",
        description:
          "Supports location planning, operatory expansion, and design decisions tied to practice goals.",
      },
    ],
  },
  {
    ...
    capabilities: [
      {
        ...
        description:
          "Helps structure policies, training reminders, incident workflows, and documentation routines.",
      },
    ],
  },
  {
    ...
    capabilities: [
      {
        ...
        description:
          "Helps evaluate systems, security needs, vendor questions, and implementation tradeoffs.",
      },
      {
